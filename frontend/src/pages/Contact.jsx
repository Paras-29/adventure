...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceID = "service_udj8z5s";
    const templateID = "template_qjh9xqm";
    const publicKey = "nbAmeKweDt6X3iID2";
  ...
  <div className="bg-white rounded-xl shadow-lg p-8">
    ...
    <div className="flex flex-wrap gap-4">
        <a href="https://www.instagram.com/parasgulvanshi/" target='_blank' className="bg-pink-600 hover:bg-pink-700 text-white p-3 rounded-lg transition-colors duration-200" aria-label="Instagram">
        ...
        <a href="https://wa.me/917737977406" target='_blank' className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-lg transition-colors duration-200" aria-label="WhatsApp">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
